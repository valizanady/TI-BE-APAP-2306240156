...
class PackageRestControllerTest {
    ...
    void setUp() {
        ...
        createPackageRequestDTO.setUserId("user-123");
    ...
    void testCreate_Success() throws Exception {
        when(packageRestService.create(any(CreatePackageRequestDTO.class)))
        ...
        verify(packageRestService, times(1)).create(any(CreatePackageRequestDTO.class));
    }
    ...
    void testCreate_ValidationError_EmptyPackageName() throws Exception {
        ...
        verify(packageRestService, never()).create(any());
    }
    ...
    void testProcessPackage_Success() throws Exception {
        ...
        when(packageRestService.processPackage(packageId)).thenReturn(processedResponse);
